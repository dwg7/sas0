...
└─ リンク集                      — occasional-reference sources, not live status (D28)
    ...
    │                               tree; 57 of 179 municipalities so far, extended in repeatable
    │                               batches (D23–D25, D31–D32), including all 35 of Hokkaido's cities
    │                               (市); every subprefecture has at least 2 entries, plus a live
